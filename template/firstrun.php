                    ...
                    <ul>
                        ...
                        <li>Manually enter additional game details, like BC (backwards compatibility), Kinect/peripherals required etc.</li>
                    </ul>
                    <p>Finally, if you want to keep your collection up to date, you should periodically:</p>
                    <ol>
                        <li>Import a new scraped prices json file.</li>
                        <li>Import your game collection csv file.</li>
